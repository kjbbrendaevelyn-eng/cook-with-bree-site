...
export default function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute top-10 right-10 text-8xl opacity-10 rotate-12 hidden sm:block">🌿</div>
      <div className="absolute bottom-10 left-10 text-6xl opacity-10 -rotate-12 hidden sm:block">🍋</div>
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 py-16 sm:py-24 md:py-32">
        <div className="max-w-2xl">
          ...
          <h1 className="font-display text-3xl sm:text-5xl md:text-6xl text-warm-brown leading-tight">
            Recipes worth sharing, stories worth telling
          </h1>
          <p className="text-base sm:text-lg text-warm-muted mt-6 leading-relaxed">
